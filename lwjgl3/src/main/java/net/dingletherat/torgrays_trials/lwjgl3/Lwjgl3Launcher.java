package net.dingletherat.torgrays_trials.lwjgl3;
...
public class Lwjgl3Launcher {
    public static void main(String[] args) {
        System.setProperty("log4j2.plugin.packages", "net.dingletherat.torgrays_trials");
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("TorgraysTrials");
        ...
        configuration.setWindowedMode(Game.screenWidth, Game.screenHeight);
